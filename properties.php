...
<?php include ("includes/sidebar.php"); ?>
      ...
      <div class="content-wrapper">
        ...
        <div class="col-xs-1 addpage">
        	<a href="propertiesadd.php"><button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Add new"><i class="fa fa-plus"></i></button></a>
        </div>
...
<?php
	...
	if(isset($s))
	{
		...
		if($s == 1)
		{
			$notification_message = "Property added successfully";				
		}
		elseif($s == 2)
		{
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <i class="fa fa-list"></i> <h3 class="box-title">Property List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
?>                    
                      <tr>
                        ...
                        <td align="center" style="min-width:125px"> <a href="propertiesview.php?p=<?= $property_id ?>"><button type="button" class="btn btn-info"><i class="fa fa-eye"></i></button></a> <a href="propertiesedit.php?p=<?= $property_id ?>"><button type="button" class="btn btn-primary"><i class="fa fa-pencil"></i></button></a> <button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></td>
                      </tr>
<?php
